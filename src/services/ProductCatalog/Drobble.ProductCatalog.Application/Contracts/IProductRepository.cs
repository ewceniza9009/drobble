...
public interface IProductRepository
{
    ...
    Task<(IEnumerable<Product> Products, int Total)> GetAllAsync(int page, int pageSize, bool? isFeatured, string? categoryId, string? sortBy, string? excludeId, CancellationToken cancellationToken = default);
