...
const Hero = () => {
    return (
        <div className="relative bg-gradient-to-br from-indigo-800 to-purple-900 text-white text-center py-8 px-4 rounded-3xl shadow-2xl overflow-hidden mb-8 group">
            ...
            <div className="relative z-10 max-w-4xl mx-auto">
                ...
                <h1 className="text-4xl md:text-5xl font-extrabold mb-6 tracking-tighter leading-tight animate-fade-in">
                    <span className="text-blue-400">Drobble</span>, Your Journey to <br/> <span className="text-yellow-300">Exceptional Finds</span> Starts Here
                </h1>
                ...
                <a
                    href="#all-products"
                    className="inline-block bg-white text-indigo-700 font-bold py-3 px-10 rounded-full shadow-lg hover:bg-gray-100 transition-all duration-300 ease-in-out transform hover:scale-105 hover:shadow-xl focus:outline-none focus:ring-4 focus:ring-white focus:ring-opacity-50 animate-bounce-once"
                >
                    Start Shopping Now
                </a>
            </div>
