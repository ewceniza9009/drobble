    ...
    if (isLoading) return (
        <div className="flex justify-center items-center p-16 min-h-96">
            <div className="text-center space-y-4">
                ...
                <p className="text-slate-600 dark:text-slate-400 font-light">Loading curated collection...</p>
            </div>
        </div>
    );
            ...
            <div className="container mx-auto px-6 relative z-10">
                ...
                <div className="text-center mb-10">
                    ...
                    <h2 className="text-4xl font-light text-slate-800 dark:text-slate-100 mb-4 tracking-tight">
                        Premium <span className="font-serif italic text-emerald-600 dark:text-emerald-400">Essentials</span>
                    </h2>
                    <p className="text-lg text-slate-600 dark:text-slate-400 max-w-2xl mx-auto leading-relaxed font-light">
                        Discover our carefully selected range of premium products, designed for exceptional quality and timeless elegance.
                    </p>
                </div>
                                    ...
                                    <div className="flex-1 w-full">
                                        <div className="relative rounded-xl overflow-hidden bg-slate-50 dark:bg-slate-700/50 shadow-lg group-hover:shadow-xl transition-all duration-500">
                                            <div className="relative w-full h-72 overflow-hidden rounded-xl">
                                                <img
                                                    src={currentProduct.imageUrl || 'https://images.unsplash.com/photo-1556228453-efd6c1ff04f6?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1000&q=80'}
                                    ...
                                    <div className="flex-1 space-y-6">
                                        <div>
                                            ...
                                            <p className="text-slate-600 dark:text-slate-400 text-base leading-relaxed mb-4 line-clamp-4">
                                                {currentProduct.description || 'Experience unparalleled quality and sophisticated design with our premium selection. Crafted with attention to detail and built to exceed expectations.'}
                                            </p>
                                        </div>
                                        ...
                                        <div className="space-y-4">
                                            <div className="flex items-center justify-between">
                                                <div className="flex flex-col">
                                                    ...
                                                    <span className="text-sm text-slate-500 dark:text-slate-400">Inclusive of all taxes</span>
                                                </div>
                                            ...
                                            <div className="flex items-center space-x-3">
                                                ...
                                                <span className="text-slate-500 dark:text-slate-400 text-sm">(127 reviews)</span>
                                            </div>
                                        </div>
                        ...
                        <div className="xl:col-span-1">
                            <div className="h-full flex flex-col space-y-6">
                                    ...
                                    {visibleThumbnails.map((product, index) => {
                                        ...
                                        return (
                                            <Tilt
                                                ...
                                                glareColor="#ffffff"
                                                className={`
                                                    cursor-pointer transition-all duration-300 rounded-xl p-4 border bg-white dark:bg-slate-800 group
                                                    ${isActive 
                                                        ? 'border-emerald-300 dark:border-emerald-500/40 bg-white dark:bg-slate-800 shadow-md transform scale-105' 
                                                    ...
                                                    <div className="flex flex-col items-center text-center space-y-3">
                                                        ...
                                                        <div className="relative">
                                                            <div className="relative w-16 h-16 rounded-lg overflow-hidden bg-slate-100 dark:bg-slate-700 shadow-sm group-hover:shadow transition-all duration-300">
                                                                <img
                                                                    src={product.imageUrl || 'https://images.unsplash.com/photo-1556228453-efd6c1ff04f6?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1000&q=80'}
                                                                    alt={product.name}
                                ...
                                <div className="flex items-center justify-center gap-3 pt-4">
                                    ...
                                    >
                                        <span className="text-slate-600 dark:text-slate-400 group-hover:text-emerald-600 dark:group-hover:text-emerald-400 text-lg">←</span>
                                    </button>
