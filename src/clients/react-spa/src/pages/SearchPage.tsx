    ...
    return (
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="text-center bg-white p-12 rounded-xl shadow-lg border border-gray-200">
          <FaSadTear className="mx-auto text-6xl text-gray-300 mb-6" />
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        {results.map((product) => (
          <Link
            ...
            className="group relative bg-white rounded-xl shadow-sm hover:shadow-2xl transition-all duration-300 border border-gray-200 overflow-hidden block"
          >
            {/* Product Image */}
